...
<h2>Recent order status <a href ="status_full.php "><button type="button">View all orders</button> </a></h2>
  <table class="tableFixHead">
    ...
    if(mysqli_num_rows($resultData) > 0){
      while($row = mysqli_fetch_assoc($resultData)){
        ...
        echo '<tr><td></td><td colspan="2">' . getOrderDetails($conn,$row['orderID']) . '</td></tr>';
      }
    }else{
      echo "No data";
    }
